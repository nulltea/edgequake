...
pub(super) fn workspace_to_response(workspace: &Workspace) -> WorkspaceResponse {
    WorkspaceResponse {
        ...
        reranker_strategy: workspace.reranker_strategy.clone(),
        reranker_model: workspace.reranker_model.clone(),
        embedding_query_instruction: workspace.embedding_query_instruction.clone(),
