...
/** Request body for POST /algorithms/extract. */
export interface AlgorithmExtractRequest {
  document_id: string;
}
...
/** Request body for POST /algorithms/{id}/review. */
export interface AlgorithmReviewRequest {
